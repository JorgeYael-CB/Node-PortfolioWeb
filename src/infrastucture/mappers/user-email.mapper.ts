...
export class UserEmailMapper {
  ...
  static getInstanceFromObj( userObject: { [key:string]:any } ):UserEmailEntity {
    const { email, id, _id, verify, isActive, date, roles, questions, name, img } = userObject;
    ...
    return new UserEmailEntity( email, id || _id, verify, isActive, date, roles, questions, name, img);
  }
